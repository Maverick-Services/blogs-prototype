        ...
        <nav className={`w-full z-50 transition-all duration-300 ${scrolled ? 'bg-white shadow-md py-0' : 'bg-white py-2'}`}>
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex items-center justify-between h-16">
                                            ...
                                            <div className="grid grid-cols-[40%_60%]">
                                                ...
                                                <div className="p-6 bg-gradient-to-br from-[#003366]/5 to-white border-r border-gray-100">
                                                    <div className="flex flex-col items-center">
                                                        ...
                                                        {/* <p className="text-sm text-gray-600 text-center mb-6 line-clamp-3">
                                                            Comprehensive solutions for all your {cat.name.toLowerCase()} needs with expert guidance.
                                                        </p> */}
                                                ...
                                                <div className="p-6">
                                                    <div className="flex justify-between items-center mb-4">
                                                        <h4 className="text-sm font-semibold text-gray-500 uppercase tracking-wide">Popular Services</h4>
                                                                ...
                                                                <li key={svc._id} className="group">
                                                                    ...
                                                                    >
                                                                        <div className="flex-1">
                                                                            <div className="font-medium text-gray-800 group-hover:text-[#003366]">{svc.name}</div>
                                                                            {/* <div className="text-xs text-gray-500 mt-1">
                                                                                Starting from ₹{Math.floor(Math.random() * 5000) + 1000}
                                                                            </div> */}
                                                                        </div>
                    ...
                    >
                        {mobileOpen ? (
                            <FiX size={24} className="text-[#003366]" />
                        ) : (
                            <FiMenu size={24} />
                        )}
                    </button>
            ...
            {mobileOpen && (
                <div
                    id="mobile-menu"
                    className={`md:hidden inset-0 bg-white z-40 transform transition-transform duration-300 ${mobileOpen ? 'translate-x-0' : 'translate-x-full'
                        }`}
                >
                    <div className="flex flex-col h-full pt-4 pb-8">
                        <div className="px-6 flex justify-between items-center mb-6">
                            <Link href="/" className="flex items-center space-x-2" onClick={() => setMobileOpen(false)}>
                                ...
                                <span className="text-xl font-bold text-[#003366]">LegalConnect</span>
                            </Link>
                            <button
                                        ...
                                        <div className="pl-4 py-2 space-y-2 bg-gray-50 rounded-lg mb-3">
                                            ...
                                            <ul className="space-y-1">
                                                {getServicesFor(cat._id).length > 0 ? (
                                                    ...
                                                    <li className="px-3 py-2 text-sm italic text-gray-500">No services available</li>
                                                )}
                                            </ul>
                                        </div>
                                    )}
