        ...
        <div className="w-full lg:flex-1">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                {services?.map(service => (
                    <div key={service._id} className="flex flex-row sm:flex-row  bg-white shadow-md rounded-sm overflow-hidden p-4">
                        <div className="w-1/3 relative h-32 sm:h-full">
                            <Image
                        ...
                        <div className="ml-5 sm:ml-6 flex-1">
                            ...
                            <p className="text-gray-600 mt-1 text-xs sm:text-sm">{service.shortDescription}</p>
